...
const ForgotPass = () => {
  ...
  const API_URL = "https://user-password-reset.herokuapp.com/users";
  ...
  const forgotPass = async (values) => {
    ...
    if (flag) {
      ...
      axios
        .post(`${API_URL}/forgotPassword`, values)

        .then((response) => {
          // console.log(JSON.stringify(response.data));
          toast.success("Email reset link sent to your email");
        })
  ...
  return (
    <>
      ...
      <Outer>
        <ToastContainer />
        <LoginCon>
          <WhoHeading>FORGOT PASSWORD</WhoHeading>
          <LoginInfo>
            <Info>Provide valid user email below</Info>
          </LoginInfo>
          <FormContainer>
